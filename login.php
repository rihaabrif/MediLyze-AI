        ...
        <div class="w-full max-w-md">
            ...
            <div class="bg-white dark:bg-dark-card rounded-xl shadow-2xl p-8">
                ...
                <form action="index.php" method="GET" class="space-y-4">
                    <input type="email" placeholder="Email" class="w-full px-4 py-2 border rounded-lg bg-gray-50 dark:bg-slate-800 focus:outline-none focus:ring-2 focus:ring-primary" required>
                    <input type="password" placeholder="Password" class="w-full px-4 py-2 border rounded-lg bg-gray-50 dark:bg-slate-800 focus:outline-none focus:ring-2 focus:ring-primary" required>
                    <button type="submit" class="w-full bg-primary hover:bg-primary-dark text-white font-bold py-2 px-4 rounded-lg">Login</button>
                </form>
                <p class="text-center mt-6 text-sm">Don't have an account? <a href="register.php" class="font-semibold text-primary hover:underline">Sign Up</a></p>
            </div>
        </div>
    </div>
